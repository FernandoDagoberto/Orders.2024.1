...
namespace Orders.Backend.UnitsOfWork.Implementations
{
    public class CategoriesUnitOfWork : GenericUnitOfWork<Category>, ICategoriesUnitOfWork
    {
        ...
        public CategoriesUnitOfWork(IGenericRepository<Category> repository, ICategoriesRepository citiesRepository) : base(repository)
        {
            _categoriesRepository = citiesRepository;
        }
